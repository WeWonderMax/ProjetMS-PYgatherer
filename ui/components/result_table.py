        ...
        for data in data_list:
            ...
            if ioc_type == "ip":
                ...
                if abuse_info:
                    ...
                    details.append(f"File Name: {abuse_info.get('file_name', 'N/A')}")
                    details.append(f"First Seen: {abuse_info.get('first_seen', 'N/A')}")
                    details.append(f"Last Seen: {abuse_info.get('last_seen', 'N/A')}")
